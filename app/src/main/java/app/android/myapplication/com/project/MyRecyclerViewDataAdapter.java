...
public class MyRecyclerViewDataAdapter extends RecyclerView.Adapter<MyRecyclerViewDataAdapter.MyRecyclerViewHolder> {
    ItemRecycleBinding itemRecyclerBinding;
    List<GitHubRepo> stringList = new ArrayList<>();
    GitHubUser gitHubUser;

    public void addData(GitHubUser user) {
        gitHubUser = user;
        List<GitHubRepo> gitHubRepos = user.getGitHubRepo();
        stringList.addAll(gitHubRepos);
    ...
    public class MyRecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindMyRecyclerView(GitHubRepo gitHubRepo) {
            ...
            mBinding.name.setText(gitHubUser.getUser().getLogin());
            mBinding.followers.setText(String.valueOf(gitHubUser.getUser().getFollowers()));
            mBinding.following.setText(String.valueOf(gitHubUser.getUser().getFollowing()));
            mBinding.repos.setText(String.valueOf(gitHubUser.getUser().getPublic_repos()));
        }
    }
}
